...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/mazen-/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@Mazen._86",
    icon: Instagram,
    url: "https://www.instagram.com/mazen._86?igsh=MTQ0cmNhaHdic3FyNg==",
    color: "#E4405F",
  ...
  },
  {
    name: "YouTube",
    displayName: "Youtube",
    subText: "@MazenMohamed-h2y",
    icon: Youtube,
    url: "https://youtube.com/@mazenmohamed-h2y?si=Xly3wWeSZEMsSCOL",
    color: "#FF0000",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@Mazenmohamed01",
    icon: Github,
    url: "https://github.com/mazenmohamed01",
    color: "#ffffff",
