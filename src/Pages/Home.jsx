...
const WORDS = ["Tech Problem Solver","Database Architect", "Backend Specialist"];
const TECH_STACK = ["ASP.NET Core", "C#", "Entity Framework", "Azure"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/mazenmohamed01" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/mazen-/" },
  { icon: Instagram, link: "https://www.instagram.com/mazen._86?igsh=MTQ0cmNhaHdic3FyNg==" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                  Building Scalable and Secure Web Applications using .NET and modern front-end technologies.
                </p>
